...
const OPERATIONAL_NAVIGATION = [
  { type: 'header', name: 'RUANG KERJA' },
  { name: 'Ruang Kerja Saya', path: '/role-dashboard', icon: '•' },
  { name: 'Ringkasan Direksi', path: '/overview', icon: '•' },
  { name: 'Organisasi', path: '/organization', icon: '•' },
  { type: 'header', name: '01 JALANKAN' },
  { name: 'Pelanggan', path: '/customers', icon: '•' },
  { name: 'Proyek', path: '/projects', icon: '•' },
  { name: 'Pustaka Alur Kerja', path: '/workflows', icon: '•' },
  { name: 'Semua Tugas', path: '/tasks', icon: '•' },
  { name: 'Tugas Saya', path: '/my-work', icon: '•' },
  { type: 'header', name: '02 KENDALIKAN' },
  { name: 'Pusat Kendali', path: '/team-dashboard', icon: '•' },
  { name: 'Pantau Risiko SLA', path: '/risk-monitor', icon: '•' },
  { name: 'Analisis Akar Masalah', path: '/root-causes', icon: '•' },
  { name: 'Kapasitas & Pembagian Kerja', path: '/workload', icon: '•' },
  { name: 'Tindakan Perbaikan', path: '/interventions', icon: '•' },
  { name: 'Eskalasi', path: '/escalations', icon: '•' },
  { type: 'header', name: '03 BELAJAR & TUMBUH' },
  { name: 'Pengetahuan & Panduan', path: '/knowledge', icon: '•' },
  { name: 'Uji Coba Alur Kerja', path: '/pilots', icon: '•' },
  { name: 'Hasil untuk Pelanggan', path: '/outcomes', icon: '•' },
  { type: 'header', name: 'KOMERSIAL' },
  { name: 'Sistem Penjualan', path: '/sales', icon: '•' },
  { name: 'Alur Penjualan', path: '/sales/pipeline', icon: '•' },
  { name: 'Pelanggan Nol', path: '/customer-zero', icon: '•' },
  { type: 'header', name: 'ADMINISTRASI' },
  { name: 'Pengguna', path: '/admin/users', icon: '•' },
  { name: 'Peran', path: '/admin/roles', icon: '•' },
  { name: 'Aturan SLA', path: '/admin/sla-rules', icon: '•' },
  { name: 'Aturan Eskalasi', path: '/admin/escalation-rules', icon: '•' },
  { name: 'Riwayat Audit', path: '/admin/audit-log', icon: '•' }
];
