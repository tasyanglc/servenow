...
export const operationsService = {
  ...
  createProject: ({ customerId, packageId, name, scope }) => {
    ...
    if (!customer || !servicePackage) return Promise.reject(new Error('Customer and service package are required.'));
